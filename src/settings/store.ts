 ...
 * (sw/sw.ts), jamais le localStorage. Ne jamais renommer ces clés : les réglages enregistrés
 * seraient perdus. Un nouveau réglage prend sa valeur par défaut sans toucher aux autres
 * (sanitizeSettings) ; en cas de changement de forme, relire l'ancienne valeur et la convertir.
 */
